...
(function () {
  ...
  function publishableFromLongform({ projectId = '', projectTitle = '', chapter, part }) {
    ...
    return {
      ...
      summary: typeof sourcePart.summary === 'string' ? sourcePart.summary.trim() : '',
      hashtags: typeof sourcePart.hashtags === 'string' ? sourcePart.hashtags.trim() : '',
      tags: tagsFromHashtags(sourcePart.hashtags),
  ...
  function publishableFromVisual({ projectId = '', projectTitle = '', entry }) {
    ...
    return {
      ...
      afterword: sourceEntry.afterword,
