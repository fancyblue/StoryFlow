...
- [ ] In the visual workspace, edit the title/body and confirm the delayed autosave reaches “已儲存”. Import duplicate-named JPG/PNG/WebP/GIF images, set cover/alt/caption, reorder with both drag and arrow controls, reload, and confirm text plus image order remain stable without a draft/ready control.
