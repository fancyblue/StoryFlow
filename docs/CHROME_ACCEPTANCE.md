...
- [ ] In each content mode, open “切換作品”. Confirm it opens as a panel under the button rather than inside the rail, that 作品名稱 below it does not move, and that it lists “＋ 新增作品” first with the same shape in both modes.
