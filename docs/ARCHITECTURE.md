...
Reading is a separate matter and is never gated this way. Importing settings.json, signing in to Google, connecting a folder and reading work back out of it are all reads; see O-07 in docs/UX_FLOW.md.
