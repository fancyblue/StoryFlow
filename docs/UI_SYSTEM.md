...
“管理章節” and “管理發布” are frequent sibling disclosure/navigation actions in a work card. They use the same high-discovery solid denim style, 40 px height and matching typography. Their normal background must retain at least 4.5:1 contrast with white control text. The current “工作台” destination remains one denim step darker, while an inactive “開啟” remains outlined. Only the open state may add the strongest selected treatment; do not assign a separate warm palette to one of them.
