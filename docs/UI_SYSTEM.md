...
- Visual workbench preview is opened by an explicit “預覽圖文” button instead of occupying the editor canvas. Publishing preview presents title controls and the main body/image sequence first; optional summary and Hashtags sit in a separate lower section.
