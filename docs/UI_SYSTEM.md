...
On the Works page, “管理章節” is the active work's primary next step and may use the solid denim fill. “工作台／開啟” is navigation, while “管理發布” is a frequent shortcut; both stay tinted or outlined. The “目前作品” badge and card treatment communicate which work is active, so the Workbench button must not impersonate a current-location state. Other work cards stay visually quiet until selected.
