...
(function () {
  const scripts = [
    ...
    { src: './src/persistence/settings-sync.js?v=20260825-p3b', owner: 'persistence' },
    ...
    { src: './src/projects/projects.js?v=20260825-p3a', owner: 'projects' },
    { src: './src/split/boundary-engine.js?v=20260825-p2b', owner: 'split' },
    { src: './src/publishing/publishing-flow.js?v=20260825-p3a', owner: 'publishing' },
    ...
    { src: './src/ui/app-ux.js?v=20260825-p3a', owner: 'ui' },
    ...
    { src: './src/ui/navigation.js?v=20260825-p3a', owner: 'ui' },
    ...
    { id: 'storyflowProjectPersistenceGuardJs', src: './src/persistence/project-persistence-guard.js?v=20260825-p3b', owner: 'persistence' },
    { id: 'storyflowMobileSafeModeJs', src: './src/persistence/mobile-safe-mode.js?v=20260825-p3b', owner: 'persistence' },
