...
(function () {
  const scripts = [
    ...
    { src: './src/core/app.js?v=20260826-p5a', owner: 'core' },
    ...
    { src: './src/projects/projects.js?v=20260826-p5a', owner: 'projects' },
    { src: './src/split/boundary-engine.js?v=20260825-p2b', owner: 'split' },
    { src: './src/publishing/publishing-flow.js?v=20260826-p5a', owner: 'publishing' },
    ...
    { id: 'storyflowProjectPersistenceGuardJs', src: './src/persistence/project-persistence-guard.js?v=20260826-p5a', owner: 'persistence' },
