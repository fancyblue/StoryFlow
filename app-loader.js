...
(function () {
  const scripts = [
    ...
    { src: './integrations.js?v=20260824-p0', owner: 'core' },
    { src: './app.js?v=20260824-flow2', owner: 'core' },
    { src: './session-auth.js?v=20260817-1522', owner: 'connection' },
    { src: './folder-session.js', owner: 'connection' },
    { src: './ui-bootstrap.js?v=20260818-1548', owner: 'ui' },
    { src: './patches.js', owner: 'legacy-bridge' },
    { src: './settings-sync.js?v=20260824-p0', owner: 'persistence' },
    { src: './workspace-safety.js?v=20260824-p0', owner: 'persistence' },
    ...
    { src: './connection-ui.js?v=20260824-flow2', owner: 'connection' },
    { src: './logout-unload-settings.js?v=20260824-privacy', owner: 'connection' },
    { src: './settings-page.js?v=20260824-privacy', owner: 'settings' },
    ...
    { src: './auth-consistency-fix.js?v=20260817-1710', owner: 'connection' },
    { src: './mobile-google-auth.js?v=20260817-1858', owner: 'connection' },
    { src: './workspace-ux-refine.js?v=20260818-1055', owner: 'ui' },
    { src: './ui-system-v4.js?v=20260820-0005', owner: 'ui' },
    { id: 'storyflowProjectPersistenceGuardJs', src: './project-persistence-guard.js?v=20260824-p0', owner: 'persistence' },
