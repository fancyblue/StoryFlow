...
(function () {
  const scripts = [
    ...
    { src: './src/persistence/integrations.js?v=20260911-a1', owner: 'persistence' },
    ...
    { src: './src/projects/projects.js?v=20260911-a1', owner: 'projects' },
    { src: './src/split/boundary-engine.js?v=20260905-p51a', owner: 'split' },
    { src: './src/publishing/publishing-flow.js?v=20260911-a1', owner: 'publishing' },
    ...
    { src: './src/ui/anchored-menu.js', owner: 'ui' },
    ...
    { src: './src/ui/navigation.js?v=20260906-a3', owner: 'ui' },
    ...
    { id: 'storyflowPublishingDeleteJs', src: './src/publishing/publishing-delete.js?v=20260911-a1', owner: 'publishing' },
    ...
    { id: 'storyflowChapterManagementJs', src: './src/projects/chapter-management.js?v=20260911-a2', owner: 'projects' },
    ...
    { id: 'storyflowVisualWorkspaceJs', src: './src/projects/visual-workspace.js?v=20260911-a2', owner: 'projects' }
  ];
