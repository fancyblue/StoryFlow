...
(function () {
  const scripts = [
    ...
    { id: 'storyflowPublishingProjectFilterJs', src: './src/publishing/publishing-project-filter.js?v=20260831-p48b', owner: 'publishing' },
    ...
    { src: './src/settings/settings-page.js?v=20260828-p19b', owner: 'settings' },
    ...
    { id: 'storyflowChapterManagementJs', src: './src/projects/chapter-management.js?v=20260831-p48a', owner: 'projects' },
