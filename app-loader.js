...
(function () {
  const scripts = [
    ...
    { src: './src/publishing/publishing-flow.js?v=20260830-p47a', owner: 'publishing' },
    ...
    { id: 'storyflowChapterManagementJs', src: './src/projects/chapter-management.js?v=20260830-p47a', owner: 'projects' },
