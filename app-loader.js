...
(function () {
  const scripts = [
    ...
    { src: './src/publishing/publishing-flow.js?v=20260829-p36a', owner: 'publishing' },
    ...
    { id: 'storyflowPublishingProjectFilterJs', src: './src/publishing/publishing-project-filter.js?v=20260829-p36a', owner: 'publishing' },
    ...
    { id: 'storyflowVisualWorkspaceJs', src: './src/projects/visual-workspace.js?v=20260829-p36a', owner: 'projects' }
  ];
