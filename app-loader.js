...
(function () {
  const scripts = [
    ...
    { src: './src/publishing/publishing-flow.js?v=20260828-p23a', owner: 'publishing' },
    ...
    { id: 'storyflowVisualWorkspaceJs', src: './src/projects/visual-workspace.js?v=20260828-p23a', owner: 'projects' }
  ];
