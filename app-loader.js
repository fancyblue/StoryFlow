...
(function () {
  const scripts = [
    ...
    { src: './src/source/project-source-sync.js?v=20260825-p1b', owner: 'source', attributes: { 'data-storyflow-project-source-sync': '' } },
    ...
    { id: 'storyflowProjectSourceModeV2Js', src: './src/source/project-source-mode-v2.js?v=20260825-p1b', owner: 'source' },
