...
(function () {
  const scripts = [
    ...
    { src: './src/publishing/publishing-flow.js?v=20260912-a1', owner: 'publishing' },
    ...
    { src: './src/connection/connection-ui.js?v=20260915-a3', owner: 'connection' },
    { src: './src/connection/logout-unload-settings.js?v=20260915-a3', owner: 'connection' },
    ...
    { src: './src/ui/navigation.js?v=20260915-a3', owner: 'ui' },
    ...
    { src: './src/ui/ui-system.js?v=20260915-a3', owner: 'ui' },
    ...
    { id: 'storyflowGlobalSearchJs', src: './src/ui/global-search.js?v=20260915-a3', owner: 'ui' },
