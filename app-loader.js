...
(function () {
  const scripts = [
    ...
    { src: './src/core/app.js?v=20260915-a2', owner: 'core' },
    ...
    { src: './src/projects/projects.js?v=20260917-a1', owner: 'projects' },
    { src: './src/split/boundary-engine.js?v=20260905-p51a', owner: 'split' },
    { src: './src/publishing/publishing-flow.js?v=20260917-a1', owner: 'publishing' },
    ...
    { id: 'storyflowPublishingProjectFilterJs', src: './src/publishing/publishing-project-filter.js?v=20260917-a1', owner: 'publishing' },
    ...
    { id: 'storyflowChapterManagementJs', src: './src/projects/chapter-management.js?v=20260917-a1', owner: 'projects' },
    ...
    { src: './src/projects/workspace-project-ux.js?v=20260915-a2', owner: 'projects' },
