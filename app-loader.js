...
(function () {
  const scripts = [
    ...
    { src: './src/publishing/publishing-flow.js?v=20260825-p2e', owner: 'publishing' },
    ...
    { id: 'storyflowPublishingProjectFilterJs', src: './src/publishing/publishing-project-filter.js?v=20260825-p2e', owner: 'publishing' },
