...
(function () {
  const scripts = [
    ...
    { src: './src/projects/projects.js?v=20260830-p45a', owner: 'projects' },
    { src: './src/split/boundary-engine.js?v=20260826-p11a', owner: 'split' },
    { src: './src/publishing/publishing-flow.js?v=20260830-p45a', owner: 'publishing' },
    ...
    { src: './src/ui/preview-mode.js?v=20260830-p45a', owner: 'ui' },
