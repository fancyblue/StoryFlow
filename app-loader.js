...
(function () {
  const scripts = [
    ...
    { src: './src/persistence/integrations.js?v=20260830-p47a', owner: 'persistence' },
    { src: './src/core/app.js?v=20260906-a1', owner: 'core' },
    ...
    { src: './src/ui/workspace-interactions.js?v=20260826-p9a', owner: 'ui' },
    { src: './src/persistence/settings-sync.js?v=20260826-p5a', owner: 'persistence' },
    ...
    { src: './src/publishing/platform-lock.js?v=20260827-p18a', owner: 'publishing' },
    ...
    { src: './src/projects/projects.js?v=20260906-a1', owner: 'projects' },
    { src: './src/split/boundary-engine.js?v=20260905-p51a', owner: 'split' },
    { src: './src/publishing/publishing-flow.js?v=20260831-p48a', owner: 'publishing' },
    ...
    { src: './src/ui/app-ux.js?v=20260906-a1', owner: 'ui' },
    { src: './src/source/source-relink.js?v=20260817-1117', owner: 'source' },
    { src: './src/connection/connection-ui.js?v=20260905-p51a', owner: 'connection' },
    { src: './src/connection/logout-unload-settings.js?v=20260825-p1f', owner: 'connection' },
    { src: './src/settings/settings-page.js?v=20260905-a1', owner: 'settings' },
    ...
    { src: './src/ui/navigation.js?v=20260906-a1', owner: 'ui' },
    ...
    { src: './src/ui/workspace-ux.js?v=20260905-a1', owner: 'ui' },
    { src: './src/ui/ui-system.js?v=20260828-p19b', owner: 'ui' },
    ...
    { id: 'storyflowProjectSourceSyncJs', src: './src/source/project-source-sync.js?v=20260906-a1', owner: 'source', attributes: { 'data-storyflow-project-source-sync': '' } },
    { id: 'storyflowSourceArticleUxJs', src: './src/source/source-article-ux.js?v=20260830-p39a', owner: 'source' },
    { id: 'storyflowChapterManagementJs', src: './src/projects/chapter-management.js?v=20260901-p51a', owner: 'projects' },
    ...
    { id: 'storyflowVisualWorkspaceJs', src: './src/projects/visual-workspace.js?v=20260831-p49a', owner: 'projects' }
  ];
