...
(function () {
  const scripts = [
    ...
    { src: './src/core/app.js?v=20260826-p9a', owner: 'core' },
    ...
    { src: './src/split/boundary-engine.js?v=20260826-p9a', owner: 'split' },
    ...
    { id: 'storyflowChapterManagementJs', src: './src/projects/chapter-management.js?v=20260826-p9a', owner: 'projects' },
