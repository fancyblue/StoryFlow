...
(function () {
  const scripts = [
    ...
    { src: './src/persistence/integrations.js?v=20260825-p1e', owner: 'persistence' },
    ...
    { src: './src/source/project-source-sync.js?v=20260817-1315', owner: 'source', attributes: { 'data-storyflow-project-source-sync': '' } },
    { src: './src/connection/connection-ui.js?v=20260824-flow2', owner: 'connection' },
    { src: './src/connection/logout-unload-settings.js?v=20260825-p1e', owner: 'connection' },
    ...
    { id: 'storyflowProjectSourceModeV2Js', src: './src/source/project-source-mode-v2.js?v=20260818-1438', owner: 'source' },
