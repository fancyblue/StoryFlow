...
(function () {
  const scripts = [
    ...
    { src: './src/projects/projects.js?v=20260918-a1', owner: 'projects' },
    ...
    { id: 'storyflowPublishingProjectFilterJs', src: './src/publishing/publishing-project-filter.js?v=20260918-a1', owner: 'publishing' },
    { src: './src/ui/anchored-menu.js?v=20260911-a3', owner: 'ui' },
    { src: './src/ui/app-ux.js?v=20260918-a1', owner: 'ui' },
    ...
    { id: 'storyflowChapterManagementJs', src: './src/projects/chapter-management.js?v=20260918-a1', owner: 'projects' },
