...
(function () {
  const scripts = [
    ...
    { id: 'storyflowPublishingProjectFilterJs', src: './src/publishing/publishing-project-filter.js?v=20260905-p52a', owner: 'publishing' },
    { src: './src/ui/app-ux.js?v=20260905-p52a', owner: 'ui' },
    ...
    { src: './src/settings/settings-page.js?v=20260905-p52a', owner: 'settings' },
    ...
    { src: './src/ui/navigation.js?v=20260905-p52a', owner: 'ui' },
    ...
    { src: './src/ui/workspace-ux.js?v=20260905-p52a', owner: 'ui' },
    ...
    { id: 'storyflowWorksLibraryUxJs', src: './src/projects/works-library-ux.js?v=20260905-p52a', owner: 'projects' },
