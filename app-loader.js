...
(function () {
  const scripts = [
    ...
    { src: './src/projects/projects.js?v=20260905-a5', owner: 'projects' },
    ...
    { id: 'storyflowPublishingProjectFilterJs', src: './src/publishing/publishing-project-filter.js?v=20260905-a5', owner: 'publishing' },
    { src: './src/ui/app-ux.js?v=20260905-a5', owner: 'ui' },
    ...
    { src: './src/ui/navigation.js?v=20260905-a1', owner: 'ui' },
