...
(function () {
  const scripts = [
    ...
    { id: 'storyflowPublishingProjectFilterJs', src: './src/publishing/publishing-project-filter.js?v=20260905-a1', owner: 'publishing' },
    { src: './src/ui/app-ux.js?v=20260905-a1', owner: 'ui' },
