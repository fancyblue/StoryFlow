...
(function () {
  const scripts = [
    ...
    { src: './src/source/source-flow.js?v=20260825-p2c', owner: 'source' },
    { src: './src/projects/projects.js?v=20260825-p2c', owner: 'projects' },
    ...
    { src: './src/ui/app-ux.js?v=20260825-p2c', owner: 'ui' },
    ...
    { id: 'storyflowPublishingDeleteJs', src: './src/publishing/publishing-delete.js?v=20260825-p2c', owner: 'publishing' },
    { id: 'storyflowProjectPersistenceGuardJs', src: './src/persistence/project-persistence-guard.js?v=20260825-p2c', owner: 'persistence' },
