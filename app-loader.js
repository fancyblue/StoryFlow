...
(function () {
  const scripts = [
    ...
    { src: './src/publishing/publishing-flow.js?v=20260915-a3', owner: 'publishing' },
    ...
    { id: 'storyflowPublishingProjectFilterJs', src: './src/publishing/publishing-project-filter.js?v=20260915-a3', owner: 'publishing' },
    ...
    { id: 'storyflowChapterManagementJs', src: './src/projects/chapter-management.js?v=20260915-a3', owner: 'projects' },
