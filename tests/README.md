...
- `visual-content-model-core.html` verifies legacy longform defaults, visual workspace round trips, the fixed-ID output/image path contract and shared publishable adapters without exposing visual mode in the UI.
